<template lang="">
    <div class="w-full h-[fit-content] bg-black border-b-[1px] border-gray-600 flex justify-between items-center px-3 py-2 font-sans">
      ...
      <nuxt-link to="/home" class="font-black text-3xl max-sm:text-lg">Muse</nuxt-link>
      ...
      <div class="max-sm:hidden mt-2 flex gap-5 items-center">
        ...
        <span class="max-sm:hidden flex gap-1 items-center font-bold max-sm:text-md" @click="signout">Signout</span>
